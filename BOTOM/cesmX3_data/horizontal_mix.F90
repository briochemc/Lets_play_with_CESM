...
!  SVN:$Id: horizontal_mix.F90 80582 2016-09-18 13:27:40Z klindsay $!
! !USES:
...
!  for IRF tracers AMB
   integer(POP_i4), parameter  :: IRF_NT = 156 ! hardcoded for X3
